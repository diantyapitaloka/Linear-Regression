...
- Extrapolation Risks: Linear regression is great at predicting within the range of your data, but it can be dangerous when predicting outside of it. For instance, the model might be unrealistically predict a 100-room house costs a billion dollars, even if such a property doesn't exist in reality.
