...
- Scikit-Learn requires the independent variable (X) to be a 2-dimensional array. Even with single feature like "bedrooms," the data must be reshaped so the model recognizes it as a matrix of features rather than a flat list.
